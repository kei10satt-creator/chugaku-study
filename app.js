...
function explanationHtml(q){
  ...
  if(q.diagram==='alternateAngles')parts.push(`<div class="mini-diagram" aria-label="錯角の図"><svg viewBox="0 0 320 180" role="img"><line x1="20" y1="50" x2="300" y2="50"/><line x1="20" y1="130" x2="300" y2="130"/><line x1="105" y1="10" x2="215" y2="170"/><path class="angle-mark" d="M132 50 A28 28 0 0 1 151 72"/><path class="angle-mark" d="M169 108 A28 28 0 0 1 188 130"/><text x="118" y="82">①</text><text x="190" y="112">②</text></svg><b>①と②が錯角。平行線なら①＝②</b><span>2本の平行線の内側で、横切る直線をはさんで反対側。</span></div>`);
  if(q.diagram==='circleAngles')parts.push(`<div class="mini-diagram" aria-label="中心角と円周角の図"><svg viewBox="0 0 320 220" role="img"><circle cx="160" cy="115" r="88" fill="none"/><circle cx="160" cy="115" r="3"/><text x="168" y="118">O</text><circle cx="96" cy="175" r="3"/><text x="82" y="194">A</text><circle cx="224" cy="175" r="3"/><text x="230" y="194">B</text><circle cx="160" cy="27" r="3"/><text x="168" y="25">P</text><line x1="160" y1="115" x2="96" y2="175"/><line x1="160" y1="115" x2="224" y2="175"/><line x1="160" y1="27" x2="96" y2="175"/><line x1="160" y1="27" x2="224" y2="175"/><text x="132" y="151">中心角</text><text x="168" y="61">円周角</text></svg><b>∠AOB＝中心角、∠APB＝円周角</b><span>同じ弧ABに対して、円周角＝中心角×1/2。</span></div>`);
